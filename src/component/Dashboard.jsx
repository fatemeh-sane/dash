...
const Dashboard = () => {
    ...
    return (<>
        <div className='container'>
            <div className="grid grid-cols-3 gap-4 relative bg-white  font-pinar ">
                <div className=" grid-rows-2 shadow rounded-xl"><img src="./images/Top.svg" alt=""/>
                    <div className=' bg-red-300'></div>
                    <div className='grid grid-cols-2  gap-4 mx-6 -mt-7'>
                ...
                <div className='bg-white shadow rounded-xl'>
                    <div className="grid  gap-4 mt-6 grid-cols-2 pl-0.5	  ">
                        ...
                        <div className='w-[24.5rem] '><img className='rounded-xl  mt-8'  src="../images/Vector 11.svg" alt=""  data-aos="fade-up"/></div>
                    </div>
                </div>
